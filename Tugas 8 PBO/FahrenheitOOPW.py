...
class FrmSuhu:
    ...
    def aturKomponen(self):
        ...
        Label(mainFrame, text='Fahrenheit:', bg="#E6E6E6").grid(row=0, column=0, sticky=W, padx=5, pady=5)
        Label(mainFrame, text="Celcius:", bg="#E6E6E6").grid(row=2, column=0, sticky=W, padx=5, pady=5)
        Label(mainFrame, text="Reamur:", bg="#E6E6E6").grid(row=3, column=0, sticky=W, padx=5, pady=5)
        ...
        self.btnHitung = Button(mainFrame, text='Hitung', command=self.onHitung, bg="blue", fg="white")
    ...
    def onHitung(self, event=None):
        try:
            F = float(self.txtFahrenheit.get())
            valuec = round(5/9 * (F - 32), 2)
