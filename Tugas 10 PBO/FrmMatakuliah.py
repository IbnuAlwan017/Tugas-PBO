...
class FormMatakuliah:
    ...
    def aturKomponen(self):
        ...
        # Label
        Label(mainFrame, text='Kode Matakuliah:').grid(row=0, column=0, sticky=W, padx=5, pady=5)
        ...
        Label(mainFrame, text='Nama Matakuliah:').grid(row=1, column=0, sticky=W, padx=5, pady=5)
        self.txtnamamk = Entry(mainFrame) 
        self.txtnamamk.grid(row=1, column=1, padx=5, pady=5) 

        Label(mainFrame, text='Jumlah sks:').grid(row=3, column=0, sticky=W, padx=5, pady=5)
...
if __name__ == '__main__':
    root = tk.Tk()
    aplikasi = FormMatakuliah(root, "Aplikasi Data Matakuliah - Ibnu Alwan(220511014) - TI22B")
    root.mainloop() 