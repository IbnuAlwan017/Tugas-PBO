...
def hitung_luas():
    try:
        ...
        ls4 = p * t
        ls5 = l * t
        luas = round(ls1 + ls2 + ls3 + ls4 + ls5, 2)
...
panjang = Label(frame, text="Panjang Alas: ", bg="#f0f0f0")
panjang.grid(row=1, column=0, sticky=W, padx=5, pady=5)

lebar = Label(frame, text="Lebar Alas: ", bg="#f0f0f0")
lebar.grid(row=2, column=0, sticky=W, padx=5, pady=5)

tinggi = Label(frame, text="Tinggi Limas: ", bg="#f0f0f0")
