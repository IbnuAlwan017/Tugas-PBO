...
app.title("Penghitung Luas Selimut, Luas Permukaan, dan Volume Selinder")
...
judul = Label(frame, text="Hitung Luas Selimut, Luas Permukaan, dan Volume Selinder", font=("Arial", 12, "bold"), bg="#f0f0f0")
...
hitung_button = Button(frame, text="Hitung", command=lambda: hitung(txtr,txtt,txtLP,txtLS,txtVolume), bg="#4CAF50", fg="white", font=("Arial", 12, "bold"))
...
app.bind('<Return>', lambda event: hitung(txtr,txtt,txtLP,txtLS,txtVolume)) 
