...
def hitung_luas_selimut():
    ...
    # Pass individual arguments to the function
    ls = FungsiPrismaSegitiga.hitung_luas_selimut(s1, s2, s3, t_prisma)
    txtLS.delete(0, END)
...
def hitung_luas_permukaan():
    ...
    lp = FungsiPrismaSegitiga.hitung_luas_permukaan(s1, s2, s3, t_prisma, a, t_segitiga)
    txtLP.delete(0, END)
...
def hitung_volume():
    ...
    t_segitiga = float(txttinggi_segitiga.get())
    t_prisma = float(txttinggi_prisma.get())
    v = FungsiPrismaSegitiga.hitung_volume(a, t_segitiga, t_prisma)
...
txtsisi1.grid(row=1, column=1, sticky=W, padx=5, pady=5)

txtsisi2 = Entry(frame, bg="lightgray", fg="black", font=("Arial", 12))
txtsisi2.grid(row=2, column=1, sticky=W, padx=5, pady=5)

txtsisi3 = Entry(frame, bg="lightgray", fg="black", font=("Arial", 12))
txtsisi3.grid(row=3, column=1, sticky=W, padx=5, pady=5)

txtalas = Entry(frame, bg="lightgray", fg="black", font=("Arial", 12))
txtalas.grid(row=4, column=1, sticky=W, padx=5, pady=5)

txttinggi_segitiga = Entry(frame, bg="lightgray", fg="black", font=("Arial", 12))
txttinggi_segitiga.grid(row=5, column=1, sticky=W, padx=5, pady=5)

txttinggi_prisma = Entry(frame, bg="lightgray", fg="black", font=("Arial", 12))
txttinggi_prisma.grid(row=6, column=1, sticky=W, padx=5, pady=5)
